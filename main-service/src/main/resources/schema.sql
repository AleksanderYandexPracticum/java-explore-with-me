DROP TABLE IF EXISTS users, locations, category, events, compilations, participations, comments, event_compilations;
...
CREATE TABLE IF NOT EXISTS event_compilations (
    events_id       BIGINT        NOT NULL    REFERENCES events (id) ON DELETE CASCADE ON UPDATE CASCADE,
    compilations_id BIGINT        NOT NULL    REFERENCES compilations (id) ON DELETE CASCADE ON UPDATE CASCADE
);